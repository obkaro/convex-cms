...
describe("Media Folder Mutations", () => {
  ...
  describe("path computation logic", () => {
    ...
    it("should handle deeply nested paths", () => {
      const path = buildFolderPath("2024", "/Images/Blog");
      expect(path).toBe("/Images/Blog/2024");
    });
  ...
  describe("path depth calculation", () => {
    ...
    it("should return correct depth for deep paths", () => {
      expect(getPathDepth("/Images/Blog/2024/January")).toBe(4);
    });
  });
  ...
  describe("createMediaFolder mutation", () => {
    it("should create a root folder successfully", async () => {
      ...
      const folder = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Images",
    ...
    it("should create a nested folder successfully", async () => {
      ...
      const parent = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Images",
      });

      // Create nested folder
      const child = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Blog",
        parentId: parent._id,
    ...
    it("should create deeply nested folders", async () => {
      ...
      const level1 = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Images",
      });

      const level2 = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Blog",
        parentId: level1._id,
      });

      const level3 = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "2024",
        parentId: level2._id,
      });

      expect(level3.path).toBe("/Images/Blog/2024");
    });
    ...
    it("should reject non-existent parent folder", async () => {
      ...
      const tempFolder = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Temp",
      });
    ...
    it("should allow same name in different parents", async () => {
      ...
      const parent1 = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Images",
      });

      const parent2 = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Documents",
      });

      // Same name "Blog" in different parents should work
      const child1 = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Blog",
        parentId: parent1._id,
      });

      const child2 = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "Blog",
  ...
  describe("updateMediaFolder mutation", () => {
    it("should update folder description", async () => {
      ...
      const updated = await t.mutation(api.mediaFolderMutations.updateMediaFolder, {
        id: folder._id,
    ...
    it("should update descendant paths when renaming", async () => {
      ...
      const updatedChild = await t.query(api.mediaFolderMutations.getMediaFolder, {
        id: child._id,
      });
  ...
  describe("moveMediaFolder mutation", () => {
    ...
    it("should update descendant paths when moving", async () => {
      ...
      const grandchild = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
        name: "2024",
        parentId: child._id,
      });
      ...
      const updatedGrandchild = await t.query(api.mediaFolderMutations.getMediaFolder, {
        id: grandchild._id,
      });

      expect(updatedGrandchild?.path).toBe("/Documents/Blog/2024");
    });
  ...
  describe("deleteMediaFolder mutation", () => {
    it("should soft delete an empty folder", async () => {
      ...
      const deleted = await t.mutation(api.mediaFolderMutations.deleteMediaFolder, {
        id: folder._id,
        deletedBy: "user-123",
      });
    ...
    it("should recursively delete folder with subfolders", async () => {
      ...
      const parentCheck = await t.query(api.mediaFolderMutations.getMediaFolder, {
        id: parent._id,
        includeDeleted: true,
      });
      const childCheck = await t.query(api.mediaFolderMutations.getMediaFolder, {
        id: child._id,
        includeDeleted: true,
      });
  ...
  describe("restoreMediaFolder mutation", () => {
    it("should restore a soft-deleted folder", async () => {
      ...
      const restored = await t.mutation(api.mediaFolderMutations.restoreMediaFolder, {
        id: folder._id,
        restoredBy: "user-123",
      });
    ...
    it("should reject restoring when parent is still deleted", async () => {
      ...
      ).rejects.toThrow(/MEDIA_FOLDER_PARENT_DELETED.*parent folder.*still deleted/);
    });
  });
  ...
  describe("query functions", () => {
    ...
    describe("listMediaFolders", () => {
      it("should list root folders", async () => {
        ...
        const folders = await t.query(api.mediaFolderMutations.listMediaFolders, {});
    ...
    describe("getMediaFolderByPath", () => {
      it("should find folder by path", async () => {
        ...
        const result = await t.query(api.mediaFolderMutations.getMediaFolderByPath, {
          path: "/Images/Blog",
        });
    ...
    describe("getFolderTree", () => {
      it("should return all folders sorted by path", async () => {
        ...
        const images = await t.mutation(api.mediaFolderMutations.createMediaFolder, {
          name: "Images",
        });
