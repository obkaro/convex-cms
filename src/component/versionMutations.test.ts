 ...
 * that store complete content state in the content_versions table.
 */
...
describe("Version Snapshot Validators", () => {
  describe("createVersionSnapshotArgs", () => {
    ...
    it("should have changeDescription as optional field", () => {
      const changeDescriptionField = createVersionSnapshotArgs.fields.changeDescription;
...
describe("Version Snapshot Integration Tests", () => {
  ...
  describe("rollbackVersion", () => {
    ...
    it("should preserve current status during rollback", async () => {
      ...
      const published = await t.mutation(api.contentEntryMutations.publishEntry, {
        id: entry._id,
      });
    ...
    it("should create audit trail with pre-rollback and post-rollback snapshots", async () => {
      ...
      expect(rollbackSnapshot.changeDescription).toContain("Rolled back to version 1");
