...
// Import derived document types from the component
import type {
 ...
 * Now derived from schema via documentTypes.ts.
 */
...
// =============================================================================
// Document Types (derived from schema via documentTypes.ts)
// =============================================================================

/**
 * Document types are now derived from the schema validators to maintain
 * a single source of truth. These re-exports provide backwards compatibility.
 *
 * @see src/component/documentTypes.ts for the source definitions
 */
export type {
  ContentType,
  ContentEntry,
...
// MediaAsset and MediaFolder types are now re-exported from documentTypes.ts above
