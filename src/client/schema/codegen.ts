...
export interface CodegenOptions {
	 ...
	 * @default "Auto-generated by convex-cms codegen"
	 */
	header?: string;
...
export async function generateTypesFromDatabase(
	...
	const {
		header = "Auto-generated by convex-cms codegen",
		includeJsDoc = true,
	...
	if (includeTypes) {
		filteredTypes = filteredTypes.filter((t: ContentType) =>
			includeTypes.includes(t.name),
		);
	}
	filteredTypes = filteredTypes.filter(
		(t: ContentType) => !exclude.includes(t.name),
	);
