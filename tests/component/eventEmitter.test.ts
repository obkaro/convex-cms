...
describe("Event Payload Types", () => {
  ...
  it("should allow minimal ContentEntryEventPayload with required fields", () => {
    ...
    expect(minimalPayload.version).toBe(1);
    // Optional fields should be undefined
    expect(minimalPayload.locale).toBeUndefined();
    expect(minimalPayload.sourceEntryId).toBeUndefined();
  });
  ...
  it("should allow minimal ContentTypeEventPayload with required fields", () => {
    ...
    expect(minimalPayload.displayName).toBe("Page");
    // Optional fields should be undefined
    expect(minimalPayload.changedFields).toBeUndefined();
  });
  ...
  it("should allow minimal MediaAssetEventPayload with required fields", () => {
    ...
    expect(minimalPayload.mimeType).toBe("application/pdf");
    // Optional fields should be undefined
    expect(minimalPayload.folderId).toBeUndefined();
    expect(minimalPayload.folderPath).toBeUndefined();
  });
});
